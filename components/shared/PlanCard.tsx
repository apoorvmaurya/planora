...
export const PlanCard = memo(function PlanCard({ plan, onShare }: PlanCardProps) {
  ...
  return (
    <motion.div 
      ...
      className="group bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden flex flex-col transition-all hover:shadow-md"
    >
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="space-y-3 mb-6 flex-1">
          ...
          <div className="flex items-center justify-between text-sm">
            <span className="text-slate-500 flex items-center gap-2"><Wallet className="w-4 h-4" /> Budget</span>
            <span className="font-semibold text-slate-900">{plan.budget_total} {plan.currency}</span>
          </div>
        </div>
