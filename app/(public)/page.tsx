        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              <Link href="/login" className="hidden md:block text-slate-600 hover:text-slate-900 font-medium transition-colors">
                Login
              </Link>
              <Link href="/signup" className="bg-[#1D9E75] hover:bg-[#15805e] text-white px-5 py-2 rounded-full font-medium transition-colors shadow-sm shadow-[#1D9E75]/30">
                Get started free
              </Link>
            </div>
          </div>
      ...
      <footer className="bg-white border-t border-slate-200 pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-slate-200 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-slate-400 text-sm font-medium flex items-center gap-1.5">Made with <Sparkles className="w-4 h-4 text-yellow-400" /> for better trips.</p>
          </div>
        </div>
      </footer>
    </div>
